...
//				printf("Add documentation.\n"), EXIT_BASIC;
				...
				if (MS == 3) {
					...
					//Period adjusters(u_2, u_4) and B.V adjuster(alpha)
					double u_1, u_2 = 0.10, u_3, u_4 = 0.10, alpha = 0.10;
...
// ToBeModified: Update this with if statements for ML and element type (and also for ParabolicPipe below).
