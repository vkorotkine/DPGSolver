...
ElseIf (MeshCurving == CURVED)
	...
	Point(8)  = {rOut,0,dz,lc};
	Point(9)  = {0,rIn,dz,lc};
	Point(10) = {Sqrt(0.5)*rIn,Sqrt(0.5)*rIn,dz,lc};
	Point(11) = {0,rOut,dz,lc};
	Point(12) = {Sqrt(0.5)*rOut,Sqrt(0.5)*rOut,dz,lc};
...
Transfinite Line {1003:1006,1010:1013}      = 2*2^(MeshLevel)+1 Using Progression 1;
Transfinite Line {1001,1002,1007:1009,1014} = 2^(MeshLevel)+1 Using Progression 1;
...
ElseIf (MeshCurving == CURVED)
	...
	Ruled Surface(4007) = {4007};
	Ruled Surface(4008) = {4008};
	Ruled Surface(4009) = {4009};
	Ruled Surface(4010) = {4010};
	Ruled Surface(4011) = {4011};
EndIf
