...
ARGV="euler/supersonic_vortex/TEST_Euler_SupersonicVortex_Conservative_DPG_ParametricMixed2D__ml1__p2 petsc_options_gmres_default"
...
#ARGV="euler/supersonic_vortex/TEST_Euler_SupersonicVortex_Conservative_DPG_BlendedMixed2D__ml1__p2"
#EXECUTABLE=@CMAKE_BINARY_DIR@/bin/test_integration_convergence
