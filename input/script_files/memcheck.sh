...
#ARGV="euler/supersonic_vortex/TEST_Euler_SupersonicVortex_DPG_ParametricMixed2D__ml0__p3"
EXECUTABLE=@CMAKE_BINARY_DIR@/bin/test_integration_convergence
ARGV="euler/supersonic_vortex/TEST_Euler_SupersonicVortex_DG_ParametricMixed2D__ml0 petsc_options_gmres_default"
