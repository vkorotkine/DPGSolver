...
void initialize_ELEMENTs(void)
{
	...
	ELEMENT->VeEcon[0*NEVEMAX  ] = 3; ELEMENT->VeEcon[0*NEVEMAX+1] = 1;
	ELEMENT->VeEcon[1*NEVEMAX  ] = 2; ELEMENT->VeEcon[1*NEVEMAX+1] = 1;
	ELEMENT->VeEcon[2*NEVEMAX  ] = 2; ELEMENT->VeEcon[2*NEVEMAX+1] = 3;
	ELEMENT->VeEcon[3*NEVEMAX  ] = 3; ELEMENT->VeEcon[3*NEVEMAX+1] = 0;
	ELEMENT->VeEcon[4*NEVEMAX  ] = 2; ELEMENT->VeEcon[4*NEVEMAX+1] = 0;
	ELEMENT->VeEcon[5*NEVEMAX  ] = 0; ELEMENT->VeEcon[5*NEVEMAX+1] = 1;
	ELEMENT->NrefV[0] = 6;
