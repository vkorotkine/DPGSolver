...
void destructor_derived_Geometry_Element (struct Element* element_ptr)
{
	...
	destructor_Multiarray_Operator(g_e->vv0_vv_vcc);
	...
	destructor_Multiarray_Operator_conditional(g_e->vv0_vms_vgs);
...
static void constructor_derived_Geometry_Element_std (struct Element* element_ptr, const struct Simulation* sim)
{
	...
	g_e->vv0_vv_vcc   = constructor_operators("vv0","vvA","vcc","H_1_P_1P", b_e,sim); // destructed
	...
	g_e->vv0_vms_fgs   = constructor_operators("vv0","vms","fgs","H_1_P_1",  b_e,sim); // destructed
...
static void constructor_derived_Geometry_Element_tp (struct Element* element_ptr, const struct Simulation* sim)
{
	...
	set_operators_tp(&ops_tp,s_e[0]->vv0_vv_vcc,NULL,s_e[1]->vv0_vv_vcc,NULL);
	g_e->vv0_vv_vcc = constructor_operators_tp("vv0","vvA","vcc","H_1_P_1P",b_e,sim,&ops_tp); // destructed
	...
	set_operators_tp(&ops_tp,s_e[0]->vv0_vms_vgs,s_e[0]->vv0_vms_fgs,s_e[1]->vv0_vms_vgs,s_e[1]->vv0_vms_fgs);
	g_e->vv0_vms_fgs   = constructor_operators_tp("vv0","vms","fgs","H_1_P_1",b_e,sim,&ops_tp); // destructed
