...
/** \brief Version of \ref constructor_xyz_fptr_T for curved surface geometry values given the corresponding surface
 *         geometry values of the affine computational element.
 *  \return See brief.
 *
