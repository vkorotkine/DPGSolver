...
struct Geometry_Element {
	...
	const struct Multiarray_Operator* cv0_vgc_fis;  ///< See notation in \ref element_operators.h.
	const struct Multiarray_Operator* vc0_fis_fgc;  ///< See notation in \ref element_operators.h.
	...
	const struct Multiarray_Operator* vv0_vms_vgs; ///< See notation in \ref element_operators.h.
	...
	const struct Multiarray_Operator* cc0_vgc_vgc; ///< See notation in \ref element_operators.h.

	const struct Multiarray_Operator* cv0_vgc_vis; ///< See notation in \ref element_operators.h.
};
