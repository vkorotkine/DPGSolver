...
struct Error_CE* constructor_Error_CE_diffusion_all (const struct Simulation* sim)
{
	const int n_out = 1; // Can add support for solution gradients in future if desired.
