...
/** \file
 *  \brief Provides the interface to functions used to set the solution for the gaussian_bump test case.
 */
...
/// \brief Function to be used for \ref Test_Case_T::set_sol for the gaussian_bump test case.
void set_sol_gaussian_bump_T
...
/** \brief Function to be used for \ref Test_Case_T::constructor_sol for the gaussian_bump test case.
 *  \return See brief. */
