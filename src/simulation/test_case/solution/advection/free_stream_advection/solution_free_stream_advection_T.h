...
/** \file
 *  \brief Provides the interface to functions used to set the solution for the free_stream_advection test case.
 */
...
/// \brief Function to be used for \ref Test_Case_T::set_sol for the free_stream_advection test case.
void set_sol_free_stream_advection_T
...
/** \brief Function to be used for \ref Test_Case_T::constructor_sol for the free_stream_advection test case.
 *  \return See brief. */
