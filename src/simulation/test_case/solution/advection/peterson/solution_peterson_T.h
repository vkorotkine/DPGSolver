...
/// \brief Function to be used for \ref Test_Case_T::set_sol for the peterson test case.
void set_sol_peterson_T
...
/** \brief Function to be used for \ref Test_Case_T::constructor_sol for the peterson test case.
 *  \return See brief. */
