...
/** \file
 *  \brief Provides the interface to functions used to set the solution for the trigonometric test case.
 */
...
/// \brief Function to be used for \ref Test_Case_T::set_sol for the trigonometric test case.
void set_sol_trigonometric_T
...
/** \brief Function to be used for \ref Test_Case_T::constructor_sol for the trigonometric test case.
 *  \return See brief. */
