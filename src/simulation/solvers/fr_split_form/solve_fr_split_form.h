...
#ifndef DPG__solve_fr_split_form_h__INCLUDED
#define DPG__solve_fr_split_form_h__INCLUDED
/** \file
...
#include "solve_fr_split_form_T.h"
...
/** \brief Version of \ref compute_rhs for the frsf method.
 *  \return See brief. */
double compute_rhs_fr_split_form
	(const struct Simulation* sim ///< \ref Simulation.
	);

/** \brief Version of \ref compute_rlhs for the frsf method.
 *  \return See brief. */
double compute_rlhs_fr_split_form
	(const struct Simulation* sim,       ///< \ref Simulation.
...
/// \brief Version of \ref compute_flux_imbalances for the FRSF scheme.
void compute_flux_imbalances_fr_split_form
	(const struct Simulation*const sim ///< See brief.
	);

#endif // DPG__solve_fr_split_form_h__INCLUDED
