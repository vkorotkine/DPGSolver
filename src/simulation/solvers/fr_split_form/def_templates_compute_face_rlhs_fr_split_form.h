...
/** \file
 *  \brief Provides the macro definitions used for c-style templating related to the rlhs computing functions for the frsf
 *         faces.
 */
...
///\{ \name Function names
#define compute_face_rlhs_fr_split_form_T                     compute_face_rlhs_fr_split_form
#define compute_flux_imbalances_faces_fr_split_form_T         compute_flux_imbalances_faces_fr_split_form
#define constructor_Numerical_Flux_Input_data_frsf_T constructor_Numerical_Flux_Input_data_fr_split_form
///\}
...
///\{ \name Function names
#define compute_face_rlhs_fr_split_form_T                     compute_face_rlhs_fr_split_form_c
#define compute_flux_imbalances_faces_fr_split_form_T         compute_flux_imbalances_faces_fr_split_form_c
#define constructor_Numerical_Flux_Input_data_frsf_T constructor_Numerical_Flux_Input_data_fr_split_form_c
///\}
