...
/** \file
 *  \brief Provides the interface for the templated \ref FRSF_Solver_Volume_T container and associated functions.
 *
...
/// \brief Container for data relating to the FRSF solver volumes.
struct FRSF_Solver_Volume_T {
	...
	/// Linearization of \ref FRSF_Solver_Volume_T::grad_coef_v wrt \ref Solver_Volume_T::sol_coef.
	const struct const_Matrix_T* d_g_coef_v__d_s_coef[DIM];
};

/// \brief Constructor for a derived \ref FRSF_Solver_Volume_T.
void constructor_derived_FRSF_Solver_Volume_T
	(struct Volume* volume_ptr,   ///< Pointer to the volume.
	 const struct Simulation* sim ///< \ref Simulation.
	);

/// \brief Destructor for a derived \ref FRSF_Solver_Volume_T.
void destructor_derived_FRSF_Solver_Volume_T
	(struct Volume* volume_ptr ///< Pointer to the volume.
	);
