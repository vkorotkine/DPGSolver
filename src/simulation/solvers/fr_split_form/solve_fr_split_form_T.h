...
/// \brief Version of \ref update_ind_dof_T for the fr_split_form method.
void update_ind_dof_fr_split_form_T
	(const struct Simulation* sim ///< \ref Simulation.
	);

/** \brief Version of \ref constructor_nnz for the fr_split_form method.
 *  \return See brief. */
struct Vector_i* constructor_nnz_frsf_T
	(const struct Simulation* sim ///< \ref Simulation.
	);
