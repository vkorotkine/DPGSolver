...
struct Solver_Volume_T {
	 ...
	 */
	const struct const_Multiarray_T* geom_coef;
	 ...
	 */
	const struct const_Multiarray_T* geom_coef_p1;
 ...
 *  \return See brief. */
const struct const_Matrix_T* constructor_mass_T
