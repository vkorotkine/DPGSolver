...
void destructor_derived_Solver_Element (struct Element* element_ptr)
{
	...
	destructor_Multiarray2_Operator(s_e->cv0_vt_vc);
	destructor_Multiarray2_Operator(s_e->cv1_vt_vc);
	...
	for (int i = 0; i < 2; ++i)
		destructor_const_Multiarray_Vector_d(s_e->w_fc[i]);
...
static void constructor_derived_Solver_Element_std (struct Element* element_ptr, const struct Simulation* sim)
{
	...
	s_e->cv0_vr_vc[0] = constructor_operators("cv0","vrA","vcs","H_CF_P_PM1",e,sim); // destructed
	s_e->cv0_vr_vc[1] = constructor_operators("cv0","vrA","vcc","H_CF_P_PM1",e,sim); // destructed
	...
	s_e->cv0_vt_vc[0] = constructor_operators("cv0","vtA","vcs","H_CF_P_PM1", e,sim); // destructed
	s_e->cv0_vt_vc[1] = constructor_operators("cv0","vtA","vcc","H_CF_P_PM1", e,sim); // destructed
	...
	s_e->cv0_vr_fc[0] = constructor_operators("cv0","vrA","fcs","H_CF_P_PM1",e,sim); // destructed
...
static void constructor_derived_Solver_Element_tp (struct Element* element_ptr, const struct Simulation* sim)
{
	...
	set_operators_tp(&ops_tp,s_se[0]->cv0_vr_vc[0],NULL,s_se[1]->cv0_vr_vc[0],NULL);
	s_e->cv0_vr_vc[0] = constructor_operators_tp("cv0","vrA","vcs","H_1_P_PM0",e,sim,&ops_tp); // destructed

	set_operators_tp(&ops_tp,s_se[0]->cv0_vr_vc[1],NULL,s_se[1]->cv0_vr_vc[1],NULL);
	s_e->cv0_vr_vc[1] = constructor_operators_tp("cv0","vrA","vcc","H_1_P_PM0",e,sim,&ops_tp); // destructed
	...
	set_operators_tp(&ops_tp,s_se[0]->cv0_vt_vc[0],NULL,s_se[1]->cv0_vt_vc[0],NULL);
	s_e->cv0_vt_vc[0] = constructor_operators_tp("cv0","vtA","vcs","H_1_P_PM0",e,sim,&ops_tp); // destructed

	set_operators_tp(&ops_tp,s_se[0]->cv0_vt_vc[1],NULL,s_se[1]->cv0_vt_vc[1],NULL);
	s_e->cv0_vt_vc[1] = constructor_operators_tp("cv0","vtA","vcc","H_1_P_PM0",e,sim,&ops_tp); // destructed

	set_operators_tp(&ops_tp,s_se[0]->cv0_vt_vc[0],s_se[0]->cv1_vt_vc[0],
	                         s_se[1]->cv0_vt_vc[0],s_se[1]->cv1_vt_vc[0]);
	s_e->cv1_vt_vc[0] = constructor_operators_tp("cv1","vtA","vcs","H_1_P_PM0",e,sim,&ops_tp); // destructed
	...
	set_operators_tp(&ops_tp,s_se[0]->cv0_vr_vc[0],s_se[0]->cv0_vr_fc[0],s_se[1]->cv0_vr_vc[0],s_se[1]->cv0_vr_fc[0]);
	s_e->cv0_vr_fc[0] = constructor_operators_tp("cv0","vrA","fcs","H_CF_P_PM1",e,sim,&ops_tp); // destructed

	set_operators_tp(&ops_tp,s_se[0]->cv0_vr_vc[1],s_se[0]->cv0_vr_fc[1],s_se[1]->cv0_vr_vc[1],s_se[1]->cv0_vr_fc[1]);
	s_e->cv0_vr_fc[1] = constructor_operators_tp("cv0","vrA","fcc","H_CF_P_PM1",e,sim,&ops_tp); // destructed

	set_operators_tp(&ops_tp,s_se[0]->tw0_vt_vc[0],s_se[0]->tw0_vt_fc[0],s_se[1]->tw0_vt_vc[0],s_se[1]->tw0_vt_fc[0]);
	s_e->tw0_vt_fc[0] = constructor_operators_tp("tw0","vtA","fcs","H_CF_P_PM1",e,sim,&ops_tp); // destructed

	set_operators_tp(&ops_tp,s_se[0]->tw0_vt_vc[1],s_se[0]->tw0_vt_fc[1],s_se[1]->tw0_vt_vc[1],s_se[1]->tw0_vt_fc[1]);
	s_e->tw0_vt_fc[1] = constructor_operators_tp("tw0","vtA","fcc","H_CF_P_PM1",e,sim,&ops_tp); // destructed

	set_operators_tp(&ops_tp,s_se[0]->cv0_vt_vc[0],s_se[0]->cv0_vt_fc[0],s_se[1]->cv0_vt_vc[0],s_se[1]->cv0_vt_fc[0]);
	s_e->cv0_vt_fc[0] = constructor_operators_tp("cv0","vtA","fcs","H_CF_P_PM1",e,sim,&ops_tp); // destructed

	set_operators_tp(&ops_tp,s_se[0]->cv0_vt_vc[1],s_se[0]->cv0_vt_fc[1],s_se[1]->cv0_vt_vc[1],s_se[1]->cv0_vt_fc[1]);
	s_e->cv0_vt_fc[1] = constructor_operators_tp("cv0","vtA","fcc","H_CF_P_PM1",e,sim,&ops_tp); // destructed
