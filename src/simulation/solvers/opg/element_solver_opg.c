...
static void constructor_derived_OPG_Solver_Element_std (struct Element* element_ptr, const struct Simulation* sim)
{
	...
	opg_s_e->cv0_vt_vc[0] = constructor_operators("cv0","vtA","vcs","H_1_P_PM0",e,sim); // destructed
	opg_s_e->cv0_vt_vc[1] = constructor_operators("cv0","vtA","vcc","H_1_P_PM0",e,sim); // destructed
