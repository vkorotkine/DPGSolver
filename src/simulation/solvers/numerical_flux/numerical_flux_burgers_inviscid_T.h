...
/** \file
 *  \brief Provides templated functions relating to inviscid Burgers numerical fluxes.
 */
...
/** \brief Version of \ref compute_Numerical_Flux_fptr_T computing the numerical fluxes and Jacobians using the Lax
 *         Friedrichs method. */
