...
#ifndef DPG__templates_matrix_constructors_c_h__INCLUDED
#define DPG__templates_matrix_constructors_c_h__INCLUDED
/** \file
...
#endif // DPG__templates_matrix_constructors_c_h__INCLUDED
