...
#ifndef DPG__templates_multiarray_math_c_h__INCLUDED
#define DPG__templates_multiarray_math_c_h__INCLUDED
/** \file
...
#endif // DPG__templates_multiarray_math_c_h__INCLUDED
