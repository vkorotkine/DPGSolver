...
#ifndef DPG__templates_type_double_complex_h__INCLUDED
#define DPG__templates_type_double_complex_h__INCLUDED
/** \file
...
#endif // DPG__templates_type_double_complex_h__INCLUDED
