...
/** \test Performs integration testing for restarted solutions (\ref test_integration_restart.cpp).
 *  \return 0 on success.
 *  \note The appropriate restart file must be created using \ref test_integration_restart_output.cpp before this test can
 ...
 *
 *  Please see comments in \ref restart_T.cpp regarding potential superconvergence of functionals depending on the
