...
/** \brief Outputs a restart file to be used for \ref test_integration_restart.cpp.
 *  \return 0 on success.
 *
 ...
 *  for this case is then the same as that for the test from \ref test_integration_convergence.cpp.
 */
int main
	(int argc,   ///< Standard.
	 char** argv ///< Standard.
