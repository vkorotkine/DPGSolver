...
/** \test Performs integration testing for the boundary conditions (\ref test_integration_boundary_conditions.cpp).
 *  \return 0 on success.
 *
	...
	(struct mutable_Boundary_Value*const m_boundary_value, const struct Numerical_Flux_Input*const num_flux_i)
{
	...
	const bool*const c_m = num_flux_i->bv_l.cppompute_member;
