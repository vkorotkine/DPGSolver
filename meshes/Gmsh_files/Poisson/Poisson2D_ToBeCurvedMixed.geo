...
//Transfinite Line {1001:1004} = 5*2^(Refine)+1 Using Progression 1;
//Transfinite Line {1005:1006} = 10*2^(Refine)+1 Using Progression 1;
//Transfinite Line {1007}      = 7*2^(Refine)+1 Using Progression 1;
