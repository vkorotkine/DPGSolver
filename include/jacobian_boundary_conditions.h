...
extern void jacobian_boundary_BackPressure      (const unsigned int Nn, const unsigned int Nel, double *WL, double *dWdW, double *nL,
                                                 const unsigned int d, const unsigned int Neq);
extern void jacobian_boundary_Total_TP          (const unsigned int Nn, const unsigned int Nel, double *XYZ, double *WL, double *dWdW,     
                                                 double *nL, const unsigned int d, const unsigned int Neq);
extern void jacobian_boundary_SupersonicInflow  (const unsigned int Nn, const unsigned int Nel, double *XYZ, double *WL, double *dWdW, 
                                                 double *nL, const unsigned int d, const unsigned int Neq);
extern void jacobian_boundary_SupersonicOutflow (const unsigned int Nn, const unsigned int Nel, double *XYZ, double *WL, double *dWdW, 
                                                 double *nL, const unsigned int d, const unsigned int Neq);
